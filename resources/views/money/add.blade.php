                ...
                <div class="container">
                    <main class="form-register input">
                        ...
                        <form action="{{ route('storeMoney') }}" method="post">
                           @csrf
                            <h1 class="h3 mb-3 fw-normal text-center">Add Money Safe</h1>
                              @error ('nis')
                              ...
                              <div class="form-floating">
                                <input type="text" name="nis" class="form-control mt-2" id="nis" placeholder="12108365">
                                <label for="nis">NIS</label>
                              </div>
                              <div class="form-floating">
                                <input type="text" name="name" class="form-control mt-2" id="name" placeholder="Your Name">
                              ...
                              <div class="form-floating mb-3">
                                   <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="class">
                              ...
                              <!-- <div class="form-floating">
                                   <input type="text" name="money" class="form-control mt-2" id="money" placeholder="Add Money">
                                   <label for="money">Money</label>
                              </div> -->
                            <div class="row justify-content-center">
                              <button class="w-50 btn btn-lg btn-secondary mt-4" type="submit">Add Money Safe</button>
                            </div>
                        </form>
                    </div>
                    </main>
